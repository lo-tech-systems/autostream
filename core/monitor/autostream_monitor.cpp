...
//
// On success the JSON line has "ok":true followed by raw binary data (s16le mono
// 16000 Hz) sent by handle_client().  On error the JSON line has "ok":false and
// no binary data follows.
//
