...
Unlike the bundled owntone-mini build, which streams to AirPlay and AirPlay 2
only, full OwnTone also supports other streaming protocols, including
Chromecast. Install it with `--owntone=full` (see [Advanced Operations](ADVANCED.md))
if you need those.
